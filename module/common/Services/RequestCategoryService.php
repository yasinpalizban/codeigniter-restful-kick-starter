...
class RequestCategoryService extends  MainService
{
    private RequestCategoryModel $model;

    public function __construct()
    {
        $this->model = new RequestCategoryModel();
    }
     ...
     * create function
     * @method : POST
     * @param RequestCategoryEntity $entity
     * @throws \ReflectionException
     */
    public function create(RequestCategoryEntity $entity)
    {
     ...
     * @throws \ReflectionException
     */
    public function update($id, RequestCategoryEntity $entity)
    {
